 ...
 * @property Pagination_helper $pagination_helper
 * @property Datetime_helper $datetime_helper
 * @property Upload_helper $upload_helper
 * @property Common_functions $common_functions
 *
 * CONTROLLERS
 * @property Authenticate $authenticate
 * @property User $user
 * @property Videogame $videogame
 * @property Game_platform $game_platform
