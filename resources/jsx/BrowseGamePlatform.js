            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" className="btn btn-default"
                            onClick={this.deleteButtonClicked.bind(this, this.props.gamePlatform.platform_id)}><i
...
var GamePlatformTable = React.createClass({
    ...
    refreshTableData: function () {
        ...
        $.ajax({
            url: this.props.siteUrl + "admin/game_platform/json_get_all_platforms",
            dataType: "json",
            data: data,
            cache: false,
    ...
    handleDeleteClicked: function (e) {
        ...
        $.ajax({
            type: "POST",
            url: this.props.siteUrl + "admin/game_platform/json_delete_by_platform_id",
            dataType: "json",
            data: data,
            success: function (data) {
    ...
    deleteButtonClicked: function (platform_id) {
        ...
        this.setState({ deletePlatformId: platform_id });
    },

    render: function () {
        var rows = [];
        //var gamePlatforms = (this.state.gamePlatforms == null) ? this.props.gamePlatforms : this.state.gamePlatforms;

        this.state.gamePlatforms.forEach(
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>
                                    Are you sure?
                                    <br/>This action <strong className="text-danger">cannot</strong> be undone.
                                </p>
                            </div>
                            <div className="modal-footer">
                                <button type="submit" className="btn btn-danger" onClick={this.handleDeleteClicked} data-dismiss="modal"><i className="fa fa-trash"></i> Delete
                                </button>
